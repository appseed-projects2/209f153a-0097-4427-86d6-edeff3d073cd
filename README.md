...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-12 12:17`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/209f153a-0097-4427-86d6-edeff3d073cd.git
$ cd 209f153a-0097-4427-86d6-edeff3d073cd
```
